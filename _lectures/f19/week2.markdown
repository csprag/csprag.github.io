---
permalink: /lectures/w19/week2.html
---
...
## [tinyurl.com/csprag-w19-everybody-gits]()
...
.center[![:img Git in Xcode, 90%](img/git-xcode.png)]
...
.center[![:img Xcode Commit Editor, 90%](img/git-xcode-commit.png)]
...
.center[![:img Git in VS Code, 80%](img/git-vscode.png)]
...
.center[![:img VS Code Commit Editor, 55%](img/git-vscode-commit.png)]
...
.center[![:img Git in vim, 70%](img/git-vim.png)]
...
.center[![:img Git in GUI vim, 80%](img/git-gvim.png)]
