...
\fancyfoot[L]{\color{gray} CSPrag --F'19}
...
\textbf{Q1: Whenever you're finished, add a screenshot of the page where the progress bar is visible.}
...
\bigskip
\noindent
\textbf{Q4: What text editor did git open for you? \rule{5cm}{0.1mm}}
...
\bigskip
\noindent
\textbf{Q5: What text editor did git open for you? \rule{5cm}{0.1mm}}

\bigskip
\noindent
\textbf{Q6: What does the \texttt{-nw} flag do?
...
\noindent
\textbf{Q7: If you set \texttt{EDITOR} and \texttt{GIT\_EDITOR} to different
